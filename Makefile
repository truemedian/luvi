...
ifdef MAKEDIR: # This is false in GNU make, and a weird target in nmake
!ifdef MAKEDIR # This is true in nmake and this segment is not evaluated in GNU make
